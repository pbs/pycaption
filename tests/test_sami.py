...
class TestSAMIReader(ReaderTestingMixIn):
    ...
    def test_non_numeric_start_raises_timing_error(self, start):
        content = f"<SAMI><BODY><SYNC Start={start}><P>hi</P></SYNC></BODY></SAMI>"
    ...
    def test_valueless_class_attribute_is_ignored(self):
        ...
        content = "<SAMI><BODY><SYNC Start=1000><P Class>hi</P></SYNC></BODY></SAMI>"
    ...
    def test_partial_margins(self, sample_sami_partial_margins):
        ...
        assert caption_set.layout_info.padding.to_xml_attribute() == "0% 29pt 0% 29pt"
    ...
    def test_sami_including_hexadecimal_charref(
        ...
        caption_set = self.reader.read(sample_sami_including_hexadecimal_charref)
